// https://stackoverflow.com/questions/57485050/how-to-increase-frame-rate-with-android-camerax-imageanalysis/57490987#57490987
// https://developer.android.com/jetpack/androidx/releases/camera#camera-core-1.0.0-alpha10
...
//                    camera2InterOp.setCaptureRequestOption(CaptureRequest.SENSOR_EXPOSURE_TIME, EXPOSURE_TIME_LIMIT_NS)
        ...
        try {
            ...
            val surface: Preview.SurfaceProvider = viewFinder.createSurfaceProvider()
//            val y : Preview.Pre
//            preview?.sur
//            textureView!!.surfaceTexture = output.getSurfaceTexture()

            preview?.setSurfaceProvider(surface)
//            preview?.setSurfaceTe
        } catch (exc: Exception) {
